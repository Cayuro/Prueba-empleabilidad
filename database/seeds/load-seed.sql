...
-- Description: Inserts initial seed data into PostgreSQL tables
...
-- 2. Insert Channels (Public and Private)
INSERT INTO rw_channels (rw_id, rw_name, rw_is_private, rw_created_by, rw_is_active, rw_created_at, rw_updated_at, rw_deleted_at)
VALUES
    ('10000000-0000-0000-0000-000000000001', 'general', FALSE, 'c0000000-0000-0000-0000-000000000001', TRUE, '2026-08-01 10:00:00+00', '2026-08-01 10:00:00+00', NULL),
    ('10000000-0000-0000-0000-000000000002', 'desarrollo-dev', FALSE, 'c0000000-0000-0000-0000-000000000002', TRUE, '2026-08-01 10:15:00+00', '2026-08-01 10:15:00+00', NULL),
    ('10000000-0000-0000-0000-000000000003', 'liderazgo-privado', TRUE, 'c0000000-0000-0000-0000-000000000001', TRUE, '2026-08-01 10:30:00+00', '2026-08-01 10:30:00+00', NULL),
    ('10000000-0000-0000-0000-000000000004', 'proyecto-frontend', TRUE, 'c0000000-0000-0000-0000-000000000002', TRUE, '2026-08-01 10:45:00+00', '2026-08-01 10:45:00+00', NULL)
...
VALUES
    -- General Channel Members (Public)
    ...
    -- Project Frontend Private Channel (Valeria and Santiago)
...
VALUES
    ...
    ('20000000-0000-0000-0000-000000000011', '10000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000002',
     'Santiago, en este chat privado de proyecto-frontend coordinaremos el diseño de la interfaz y la integración de STOMP WebSocket.',
    ...
    ('20000000-0000-0000-0000-000000000012', '10000000-0000-0000-0000-000000000004', 'c0000000-0000-0000-0000-000000000003',
     'Perfecto Valeria. Ya tengo listos los componentes de conversaciones, chat y copilot con Tailwind CSS.',
