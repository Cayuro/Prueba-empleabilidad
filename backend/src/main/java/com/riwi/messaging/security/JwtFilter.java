...
// Validates Bearer token and attaches authenticated user UUID to request and security context
@Component
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            ...
            try {
                ...
                // Registers authentication principal in Spring Security context
